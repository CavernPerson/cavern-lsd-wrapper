...
pub fn instantiate(
    ...
    cavern_lsd_wrapper_token_with_limit::contract::instantiate::<StrideLSDConfigRaw, StrideLSDConfig>(
        deps, env, info, msg,
    )
}
...
pub fn execute(
    ...
    cavern_lsd_wrapper_token_with_limit::contract::execute::<StrideLSDConfigRaw, StrideLSDConfig>(
        deps, env, info, msg,
    )
}
